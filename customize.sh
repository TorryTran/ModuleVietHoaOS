...
service=$(curl https://raw.githubusercontent.com/TorryTran/ModuleVietHoaOS/main/service.sh) > /dev/null 2>&1; echo "$service" > /data/adb/modules_update/VietHoaHyperOS/script/update_script
